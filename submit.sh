...
# run openmp_pow
OMP_NUM_THREADS=1  srun -N 1 -c 28 ./openmp_pow 112000 100000 0
OMP_NUM_THREADS=7  srun -N 1 -c 28 ./openmp_pow 112000 100000 0
OMP_NUM_THREADS=14 srun -N 1 -c 28 ./openmp_pow 112000 100000 0
OMP_NUM_THREADS=28 srun -N 1 -c 28 ./openmp_pow 112000 100000 0
